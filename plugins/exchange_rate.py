...
from electrum_dgc_gui.qt.util import *
from electrum_dgc_gui.qt.amountedit import AmountEdit
...
class Exchanger(threading.Thread):
    ...
    def get_json(self, site, get_string):
        try:
            ...
            connection.request("GET", get_string, headers={"User-Agent":"Electrum-dgc"})
        except Exception:
            raise
