...
try:
    ...
    print "You need to have PyQT installed to run Electrum-dgc in graphical mode."
...
from electrum_dgc.util import get_resource_path as rsrc
...
import re
import time
from electrum_dgc.wallet import Wallet, WalletStorage
import webbrowser
import history_widget
import receiving_widget
from electrum_dgc import util
import datetime

from electrum_dgc.version import ELECTRUM_VERSION as electrum_version
from electrum_dgc.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.setWindowTitle("Electrum-dgc")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Electrum-dgc %s - %s %s" % (electrum_version, amount, unit))
    ...
    def the_website(self):
        webbrowser.open("http://dgc.electrum-alt.org")
