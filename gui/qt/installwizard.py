...
from electrum_dgc import Wallet, Wallet_2of2, Wallet_2of3
from electrum_dgc import bitcoin
...
from electrum_dgc.mnemonic import prepare_seed
...
class InstallWizard(QDialog):
    ...
    def waiting_dialog(self, task, msg= _("Electrum-dgc is generating your addresses, please wait.")):
        def target():
            task()
