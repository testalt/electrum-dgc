...
from electrum_dgc.i18n import _, set_language
from electrum_dgc.util import print_error, print_msg
...
from electrum_dgc.bitcoin import MIN_RELAY_TX_FEE, is_valid
from electrum_dgc.plugins import run_hook

import icons_rc

from electrum_dgc.util import format_satoshis
from electrum_dgc import Transaction
from electrum_dgc import mnemonic
from electrum_dgc import util, bitcoin, commands, Interface, Wallet
from electrum_dgc import SimpleConfig, Wallet, WalletStorage
from electrum_dgc import Imported_Wallet
...
from electrum_dgc import ELECTRUM_VERSION
import re
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/electrum-dgc.png"))
        self.init_menubar()
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Electrum-dgc ' + self.wallet.electrum_version + '  -  ' + self.wallet.storage.path
    ...
    def backup_wallet(self):
        ...
        if new_path != path:
            try:
                ...
                QMessageBox.critical(None,"Unable to create backup", _("Electrum-dgc was unable to copy your wallet file to the specified location.")+"\n" + str(reason))
    ...
    def init_menubar(self):
        ...
        tools_menu.addAction(_("Electrum-dgc preferences") if sys.platform == 'darwin' else _("Preferences"), self.settings_dialog)
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://dgc.electrum-alt.org/electrum"))
    ...
    def show_about(self):
        QMessageBox.about(self, "Electrum-dgc",
    ...
    def show_report_bug(self):
        QMessageBox.information(self, "Electrum-dgc - " + _("Reporting Bugs"),
    ...
    def notify(self, message):
        if self.tray:
            self.tray.showMessage("Electrum-dgc", message, QSystemTrayIcon.Information, 20000)
    ...
    def create_send_tab(self):
        ...
        self.payto_help = HelpButton(_('Recipient of the funds.') + '\n\n' + _('You may enter a Dogecoin address, a label from your list of contacts (a list of completions will be proposed), or an alias (email-like address that forwards to a Ixcoin address)'))
    ...
    def pay_from_URI(self,URI):
        ...
        from electrum_dgc import paymentrequest
        def payment_request():
    ...
    def show_invoice(self, key):
        from electrum_dgc.paymentrequest import PaymentRequest
    ...
    def tx_from_text(self, txt):
        ...
        if is_hex:
            try:
                ...
                traceback.print_exc(file=sys.stdout)
                QMessageBox.critical(None, _("Unable to parse transaction"), _("Electrum-dgc was unable to parse your transaction"))
                return
    ...
    def read_tx_from_file(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to read file or no transaction found"), _("Electrum-dgc was unable to open your transaction file") + "\n" + str(reason))
    ...
    def export_privkeys_dialog(self, password):
        ...
        defaultname = 'electrum-dgc-private-keys.csv'
        ...
        try:
            ...
            export_error_label = _("Electrum-dgc was unable to produce a private key-export.")
    ...
    def do_import_labels(self):
        ...
        try:
            ...
            QMessageBox.critical(None, _("Unable to import labels"), _("Electrum-dgc was unable to import your labels.")+"\n" + str(reason))


    def do_export_labels(self):
        labels = self.wallet.labels
        try:
            fileName = self.getSaveFileName(_("Select file to save your labels"), 'electrum_dgc_labels.dat', "*.dat")
            if fileName:
                with open(fileName, 'w+') as f:
                    json.dump(labels, f)
                QMessageBox.information(None, _("Labels exported"), _("Your labels where exported to")+" '%s'" % str(fileName))
        except (IOError, os.error), reason:
            QMessageBox.critical(None, _("Unable to export labels"), _("Electrum-dgc was unable to export your labels.")+"\n" + str(reason))
    ...
    def export_history_dialog(self):
        ...
        defaultname = os.path.expanduser('~/electrum-dgc-history.csv')
        ...
        try:
            ...
            export_error_label = _("Electrum-dgc was unable to produce a transaction export.")
    ...
    def settings_dialog(self):
        ...
        d = QDialog(self)
        d.setWindowTitle(_('Electrum-dgc Settings'))
        d.setModal(1)
        vbox = QVBoxLayout()
        grid = QGridLayout()
        ...
        from electrum_ixc.i18n import languages
        ...
        def on_unit(x):
            ...
            elif unit_result == 'mDGC':
                self.decimal_point = 5
            elif unit_result == 'dbits':
        ...
        if self.need_restart:
            QMessageBox.warning(self, _('Success'), _('Please restart Electrum-dgc to activate the new GUI settings'), _('OK'))



    def run_network_dialog(self):
        if not self.network:
            QMessageBox.warning(self, _('Offline'), _('You are using Electrum-dgc in offline mode.\nRestart Electrum-IXC if you want to get connected.'), _('OK'))
            return
    ...
    def plugins_dialog(self):
        from electrum_dgc.plugins import plugins

        d = QDialog(self)
        d.setWindowTitle(_('Electrum-dgc Plugins'))
        d.setModal(1)
