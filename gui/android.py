...
from electrum_dgc import SimpleConfig, Wallet, WalletStorage, format_satoshis, mnemonic_encode, mnemonic_decode
...
def pay_to(recipient, amount, fee, label):
    ...
    droid.dialogCreateSpinnerProgress("Electrum-dgc", "signing transaction...")
    droid.dialogShow()
...
class ElectrumGui:
    ...
    def restore_wallet(self):
        ...
        droid.dialogCreateSpinnerProgress("Electrum-dgc", msg)
        droid.dialogShow()
