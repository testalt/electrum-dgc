...
_ = lambda x:x
#from i18n import _
from electrum_dgc.wallet import WalletStorage, Wallet
from electrum_dgc.util import format_satoshis, set_verbosity
from electrum_dgc.bitcoin import is_valid
from electrum_dgc.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-dgc create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-dgc setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-dgc setconfig' to change your settings")
        return True
